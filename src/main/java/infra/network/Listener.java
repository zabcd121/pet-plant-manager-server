...
public class Listener {
    ...
    public Listener(AccountRepository accRepo, PlantRepository plantRepo, PetPlantRepository petPlantRepo, NoticeRepository noticeRepo){
    ...
    public synchronized void addThread(Socket socket) throws IOException {
        ...
        if (clientCount < clients.length) {
            clientCount++;
            Server thread = new Server(socket, clientCount, accRepo, plantRepo, petPlantRepo, noticeRepo);
